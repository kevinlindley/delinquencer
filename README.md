...
![alt text](https://github.com/kevinlindley/delinquencer-support/blob/main/DelinqunecerRunningOnNornsSmall.png "delinquencer running on a Norns Shield" | width = 300 )
